...
prompt_user = """Considering education and job history of the individaul below and job description 
write Personal Statement for the CV. Focus on the most recent acomplishments of the individaul
especially CodeClan Bootcamp as he's seeking the role as a Junior Software developer. 
...
completion = client.chat.completions.create(
    ...
    messages=[
        {
            "role": "user",
            "content": f"{prompt_user} CV: {cv_text} and here's job description {jobs_sorted[0]}",
        }
    ],
)
